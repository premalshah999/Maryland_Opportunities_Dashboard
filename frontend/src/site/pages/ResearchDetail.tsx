            ...
            <div className="space-y-10">
              ...
              <section className="border-b border-gray-100 pb-8">
                ...
                <div className="space-y-4 text-gray-700 leading-8">
                  ...
                  <p>Total transactions: 11 million</p>
                  <p>Total transaction volume: $108 million</p>
                  <p>Total unique customers: 345,000</p>
              ...
              <section className="border-b border-gray-100 pb-8">
                ...
                <div className="space-y-4 text-gray-700 leading-8">
                  ...
                  <p>Business-to-Business (B2B): Providers partner with employers and integrate with payroll systems to facilitate wage advances directly through the workplace.</p>
                  <p>Direct-to-Consumer (D2C): Providers work directly with workers by linking to their bank accounts to verify earnings, without requiring employer participation.</p>
              ...
              <section className="border-b border-gray-100 pb-8">
                ...
                <div className="space-y-4 text-gray-700 leading-8">
                  ...
                  <p>Expedited Transfer Fees: Most providers offer a no-cost option requiring up to two business days for disbursement. To receive funds faster, users pay fees ranging from $2 to $5 per advance.</p>
                  <p>High Effective APR: Given that most transactions fall between $25 and $100, flat fees translate into substantial annualized costs. The average APR across providers exceeds 100%, ranging from 42% to over 200%, depending on the firm.</p>
                  <p>Voluntary Tips: While framed as optional, tips are common in practice. Among providers reporting detailed data, the average cumulative tip per user reached over $280 over the sample period of five years.</p>
                </div>
              </section>
              ...
              <section className="border-b border-gray-100 pb-8">
                ...
                <div className="space-y-4 text-gray-700 leading-8">
                  ...
                  <p>Persistent Reliance: Rather than serving as an occasional emergency tool, EWA appears embedded in regular cash-flow management. Most users have 51 or more repeat transactions during a five-year period, and 23% use the service at least once every two weeks.</p>
                </div>
                ...
                <div className="space-y-4 text-gray-700 leading-8 mt-6">
                  <p>Limited Financial Improvement: Despite repeated usage, EWA does not appear to alleviate underlying financial constraints. Nearly 50% of users remain unable to cover emergency expenses even after using the service.</p>
                  <p>Behavioral Consequences: EWA usage is associated with changes in work behavior. Among surveyed users, 46% reported working more hours or taking on additional shifts as a result of using EWA services.</p>
                </div>
              </section>
              ...
              <section className="border-b border-gray-100 pb-8">
                ...
                <div className="space-y-4 text-gray-700 leading-8 mt-6">
                  ...
                  <p>Financial Literacy (0-5 points): Based on objective questions assessing respondents' financial knowledge.</p>
